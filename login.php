        ...
        <div class="col-md-6"> 
          <?php echo $msg; ?>
            <div class="page-header">
                <h1 style="text-align: center; background-color: black; color: white; width: 100%; margin: auto; opacity: 0.75">Login</h1>     
          </div> 
           <br><br><br>
            <form class="form-horizontal animated bounce" action="" method="post" class="content"> 
